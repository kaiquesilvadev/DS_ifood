...
INSERT INTO tb_pedido (codigo, sub_total, taxa_frete, valor_total, status_pedido, data_criacao, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, forma_pagamento_id, usuario_id, restaurante_id ,endereco_cidade_id)VALUES ('ITL_PEDIDO_1', 50.00, 5.00, 55.00, 'CONFIRMADO', NOW(), '12345-678', 'Rua das Flores', '123', 'Apartamento 101', 'Centro', 1, 1, 1 , 1);
INSERT INTO tb_pedido (codigo, sub_total, taxa_frete, valor_total, status_pedido, data_criacao, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, forma_pagamento_id, usuario_id, restaurante_id ,endereco_cidade_id)VALUES ('ITL_PEDIDO_2', 40.00, 3.00, 43.00, 'ENTREGUE', NOW(), '54321-876', 'Avenida dos Anjos', '456', 'Casa', 'Bela Vista', 2, 2, 1 ,1);
INSERT INTO tb_pedido (codigo, sub_total, taxa_frete, valor_total, status_pedido, data_criacao, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, forma_pagamento_id, usuario_id, restaurante_id ,endereco_cidade_id)VALUES ('ITL_PEDIDO_3', 30.00, 4.00, 34.00, 'CANCELADO', NOW(), '98765-432', 'Praça da Liberdade', '789', 'Sala 201', 'Liberdade', 1, 2, 1 ,2);
INSERT INTO tb_pedido (codigo, sub_total, taxa_frete, valor_total, status_pedido, data_criacao, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, forma_pagamento_id, usuario_id, restaurante_id ,endereco_cidade_id)VALUES ('JPN_PEDIDO_1', 60.00, 6.00, 66.00, 'CONFIRMADO', NOW(), '13579-246', 'Rua Sakura', '987', 'Bloco B', 'Harajuku', 2, 1, 2 ,2);
INSERT INTO tb_pedido (codigo, sub_total, taxa_frete, valor_total, status_pedido, data_criacao, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro, forma_pagamento_id, usuario_id, restaurante_id ,endereco_cidade_id)VALUES ('JPN_PEDIDO_2', 70.00, 7.00, 77.00, 'ENTREGUE', NOW(), '64237-810', 'Avenida Fuji', '345', 'Casa 2', 'Shibuya', 1, 2, 2 ,1);
